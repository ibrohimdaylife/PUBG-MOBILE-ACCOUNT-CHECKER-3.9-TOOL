...
user_agent = f"Dalvik/2.1.0 (Linux; U; Android 9; SM-S918B Build/PI)"
...
with open("request_count_2.txt", "r") as file:
...
def build_login_request(current_ms_nano, current_ms, current_ts, n_value, randstr_input, ticket_input, email, password_plain):
    ...
    dinfo = f"1|43405|SM-S918B|en|3.9.0|{current_ms_2}|1.5|1280*720|samsung|23892eabf941a0b0728901325f0a9c4f|arm64-v8a+x86_64|Android \\/ API-28(samsung-user 9.0.0 20171130.276299 release-keys)"
    ...
    request = (
        ...
        f"\"sUgId\":\"5b4cdae92453b4284071f9468fe10a94a73d902438c8d4a83a4358f5fd765181\","
...
def send_login_request(url: str, natija: str, user_agent):
    ...
    try:
        ...
        with open("request_count_2.txt", "r") as file:
            count = int(file.read())
        count += 1
        with open("request_count_2.txt", "w") as file:
