...
user_agent = f"Dalvik/2.1.0 (Linux; U; Android 9; SM-S928B Build/PI)"
...
with open("request_count_1.txt", "r") as file:
...
def build_login_request(current_ms_nano, current_ms, current_ts, n_value, randstr_input, ticket_input, email, password_plain):
    ...
    dinfo = f"1|43405|SM-S928B|en|3.9.0|{current_ms_2}|1.875|1600*900|samsung|23892eabf941a0b0728901325f0a9c4f|arm64-v8a+x86_64|Android \\/ API-28(samsung-user 9.0.0 20171130.276299 release-keys)"
    ...
    request = (
        ...
        f"\"sUgId\":\"7e1ba6e204a792014a1a4f29d572aa99a1e02c203e1568ac458784f382b28d87\","
...
def send_login_request(url: str, natija: str, user_agent):
    ...
    try:
        ...
        with open("request_count_1.txt", "r") as file:
            count = int(file.read())
        count += 1
        with open("request_count_1.txt", "w") as file:
